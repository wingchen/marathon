...
class TaskBuilderTest extends MarathonSpec {
  ...
  test("BuildIfMatches") {
    val offer = makeBasicOffer(1.0, 128.0, 2.0, 31000, 32000)
      .addResources(ScalarResource("cpus", 1))
      .addResources(ScalarResource("mem", 128))
      .addResources(ScalarResource("disk", 2))
      .build
  ...
  test("BuildIfMatchesWithRole") {
    val offer = makeBasicOfferWithRole(1.0, 128.0, 1.0, 31000, 32000, "marathon")
      .addResources(ScalarResource("cpus", 1, "*"))
      .addResources(ScalarResource("mem", 128, "*"))
      .addResources(ScalarResource("disk", 1, "*"))
      .addResources(ScalarResource("cpus", 2, "marathon"))
      .addResources(ScalarResource("mem", 256, "marathon"))
      .addResources(ScalarResource("disk", 2, "marathon"))
  ...
  test("BuildIfMatchesWithRole2") {
    val offer = makeBasicOfferWithRole(1.0, 128.0, 1.0, 31000, 32000, "*")
      .addResources(ScalarResource("cpus", 1, "*"))
      .addResources(ScalarResource("mem", 128, "*"))
      .addResources(ScalarResource("disk", 1, "*"))
      .addResources(ScalarResource("cpus", 2, "marathon"))
